...
import aiohttp, pylast, asyncio, os
...
netwrk = pylast.LastFMNetwork(api_key=os.environ.get("LASTFM_API_KEY"), api_secret=os.environ.get("LASTFM_SECRET"), username=os.environ.get("LASTFM_USERNAME"), password_hash=pylast.md5(os.environ.get("LASTFM_PASSWORD")))
